...
const char* PY_SCHEMA_CONSTANTS::TYPE_LOCALIZATIONID = "localizationID";
...
const char* PY_SCHEMA_CONSTANTS::ATTRIBUTE_KEYFOOTERSCHEMA = "keyFooter";
...
const char* PY_SCHEMA_CONSTANTS::LIST_LENGTH = "length";
